...
public class JdbcSpittleRepositoryTest {
    ...
    public void findOne() {
        ...
        assertEquals(Instant.ofEpochMilli(1332682500000L), thirteen.getPostedTime());
    ...
    public void save() {
        ...
        Spittle spittle = new Spittle(null, spitter, "Un Nuevo Spittle from Art", Instant.now());
